...
class JarvisUI(QWidget):
    ...
    def init_ui(self):
        ...
        self.add_gif_to_label(self.mic_label,
                              r"D:\Python\JARVIS 2.O\ai_jarvis.gif",
                              size=(1918, 1079), alignment=Qt.AlignCenter)  # Initial size and alignment
    ...
    def run_main_file(self):
        try:
            ...
            path_to_main_py = os.path.join(current_directory, r"D:\Python\JARVIS 2.O\main.py")
